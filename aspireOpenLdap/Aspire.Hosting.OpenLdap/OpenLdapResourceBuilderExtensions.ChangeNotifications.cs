...
// Deliberately no first-party subscribe API — see the WithChangeNotifications remarks.
// (Class-level XML docs live on the main partial.)
public static partial class OpenLdapResourceBuilderExtensions
{
    ...
    /// resource's endpoint — the CLI baseline is <c>ldapsearch -E sync=rp</c>.
    ...
    /// stops; a larger checkpoint interval can regress it, making resuming clients replay seen
    /// changes. See <see cref="OpenLdapOverlay.SyncProv"/>.
    /// </param>
