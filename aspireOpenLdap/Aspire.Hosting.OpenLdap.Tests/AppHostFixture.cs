...
/// config-witness facts, for example). Encapsulates the CreateAsync → BuildAsync → StartAsync →
/// WaitForResourceHealthyAsync → GetConnectionStringAsync → Parse sequence every
/// AppHost-backed test needs.
/// </summary>
/// <remarks>
